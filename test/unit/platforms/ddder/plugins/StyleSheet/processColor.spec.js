...
describe('processColor', () => {
  describe('predefined color names', () => {
    it('should convert red', () => {
      ...
      expect(colorFromString).toEqual('rgba(255, 0, 0, 1)')
    })

    it('should convert white', () => {
      var colorFromString = processColor('white')
      expect(colorFromString).toEqual('rgba(255, 255, 255, 1)')
    })

    it('should convert black', () => {
      var colorFromString = processColor('black')
      expect(colorFromString).toEqual('rgba(0, 0, 0, 1)')
    })
  ...
  describe('RGB strings', () => {
    it('should convert rgb(x, y, z)', () => {
      ...
      expect(colorFromString).toEqual('rgba(10, 20, 30, 1)')
    })
  })
  ...
  describe('RGBA strings', () => {
    it('should convert rgba(x, y, z, a)', () => {
      ...
      expect(colorFromString).toEqual('rgba(10, 20, 30, 0.40)')
    })
  })
  ...
  describe('HSL strings', () => {
    it('should convert hsl(x, y%, z%)', () => {
      ...
      expect(colorFromString).toEqual('rgba(219, 61, 172, 1)')
    })
  })
  ...
  describe('HSLA strings', () => {
    it('should convert hsla(x, y%, z%, a)', () => {
      ...
      expect(colorFromString).toEqual('rgba(219, 61, 172, 0.25)')
    })
  })
  ...
  describe('hex strings', () => {
    it('should convert #xxxxxx', () => {
      ...
      expect(colorFromString).toEqual('rgba(30, 131, 201, 1)')
    })
  })
})
